...
public class KeywordTagger {
    ...
    public List<Map.Entry<String, String>> getKeywords(String text){
        //TODO 佟安完成
        if(StringUtil.isEmpty(text)){
            ...
            for(AhoCorasickDoubleArrayTrie.Hit<String> hit: hits){
                ...
                Map.Entry<String, String> key_tag = new AbstractMap.SimpleEntry<String,String>(keyword_map,hit.value);
